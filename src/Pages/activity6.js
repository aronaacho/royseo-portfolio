        ...
        <div className="fade-item page-content report-body">
            <div className="wecare-activity-photo-wrapper">
                <div className='photo-wrapper'>
                    <img key="0" src={"/img/royseo-dessert.jpeg"} alt={"coffee and kaymak with an old project member for the project update"} className="roy-img"/>
                <p className='right-activity-text'> I met with an old project member and shared updates on the progress of my ongoing project. With the end of the year approaching, I feel an urgent need to complete my work. Although I couldn’t take a photo to document it, a major breakthrough was identifying some critical mistakes in my script with the help of my friend. We’ve now determined the next steps, such as optimizing the training process. Additionally, I’m planning to give a talk on this project in January. Stay tuned!
